...
class FTPClient:
    ...
    def upload_file(self, local_path, remote_path=None):
        ...
        # If no remote path specified, use the filename
    ...
    def download_file(self, remote_path, local_path=None):
        ...
        # If no local path specified, use the filename in current directory
...
class FTPInteractiveShell(cmd.Cmd):
    ...
    def __init__(self):
        ...
        self.client = FTPClient(self.host, self.port, self.username, self.password)
    ...
    def do_stats(self, args):
        ...
        try:
            # Get server status if supported
...
def main():
    ...
    if len(sys.argv) == 1:
        ...
        # Command mode
        parser = argparse.ArgumentParser(description="FTP Client for Cybersecurity Lab")
        parser.add_argument('command', help='Command to execute (upload, download, ls, connect)')
        parser.add_argument('args', nargs='*', help='Arguments for the command')
        parser.add_argument('--host', default=None, help='FTP server host')
        parser.add_argument('--port', type=int, default=None, help='FTP server port')
